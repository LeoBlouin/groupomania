...
const editPost = async () => {
  try {
    ...
    await postService.editPost(props.postId, { ...fields })
    closeModal()
    successToast('Post modifié avec succès !')
  } catch {
...
<template>
  <i
    class="fa-solid fa-pen-to-square cursor-pointer duration-300 hover:text-primary"
    @click="openModal"></i>
        ...
        <div class="flex min-h-full items-center justify-center p-4 text-center">
          <TransitionChild
            ...
            <DialogPanel
              ...
              <form class="mt-10 flex flex-col space-y-8" @submit.prevent="editPost">
                <InputWithLabel
                  label="Titre du post"
                  type="text"
                  name="title"
              ...
              <div class="mt-12 flex space-x-5">
                ...
                <PrimaryButton text="Modifier" @click="editPost" />
              </div>
            </DialogPanel>
          </TransitionChild>
        </div>
